...
class TimeZoneHelperImpl:TimeZoneHelper {
    override fun getTimeZoneString(): List<String> {
   return TimeZone.availableZoneIds.sorted();
    ...
    val currentTimeZone=TimeZone.currentSystemDefault()
        val currentUtCInstance:Instant=Clock.System.now()
        val otherTimeZone=TimeZone.of(otherTimeZoneId)
        val  currentDateTime=currentUtCInstance.toLocalDateTime(currentTimeZone)
        val currentOtherDateTime=currentUtCInstance.toLocalDateTime(otherTimeZone)
    ...
    private fun isValid(
        ...
        val otherDateTimeWithHour=LocalDateTime(currentOtherDateTime.year, currentOtherDateTime.month,currentOtherDateTime.dayOfMonth,currentOtherDateTime.hour,0,0,0)
